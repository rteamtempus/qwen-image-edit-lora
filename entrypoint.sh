...
# If a RunPod Network Volume is attached, let ComfyUI also load models from it
# (so you can add LoRAs by dropping files in <volume>/loras with NO image rebuild).
if [ -d "/runpod-volume" ]; then
    echo "📦 Network volume detected — adding /runpod-volume to ComfyUI model search paths."
